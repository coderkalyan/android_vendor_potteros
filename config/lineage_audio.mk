...
ALARM_PATH := vendor/potter/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/potter/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/potter/prebuilt/common/media/audio/ringtones
